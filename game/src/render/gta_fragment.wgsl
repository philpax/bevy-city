...
let GTA_MATERIAL_FLAGS_EMISSIVE_TEXTURE_BIT: u32           = 2u;
let GTA_MATERIAL_FLAGS_METALLIC_ROUGHNESS_TEXTURE_BIT: u32 = 4u;
let GTA_MATERIAL_FLAGS_OCCLUSION_TEXTURE_BIT: u32          = 8u;
let GTA_MATERIAL_FLAGS_DOUBLE_SIDED_BIT: u32               = 16u;
let GTA_MATERIAL_FLAGS_UNLIT_BIT: u32                      = 32u;
let GTA_MATERIAL_FLAGS_ALPHA_MODE_OPAQUE: u32              = 64u;
let GTA_MATERIAL_FLAGS_ALPHA_MODE_MASK: u32                = 128u;
let GTA_MATERIAL_FLAGS_ALPHA_MODE_BLEND: u32               = 256u;
let GTA_MATERIAL_FLAGS_TWO_COMPONENT_NORMAL_MAP: u32       = 512u;
let GTA_MATERIAL_FLAGS_FLIP_NORMAL_MAP_Y: u32              = 1024u;

[[group(1), binding(0)]]
var<uniform> material: GtaMaterial;
[[group(1), binding(1)]]
...
fn fragment(in: FragmentInput) -> [[location(0)]] vec4<f32> {
    ...
    if ((material.flags & GTA_MATERIAL_FLAGS_UNLIT_BIT) == 0u) {
        ...
        if ((material.flags & GTA_MATERIAL_FLAGS_EMISSIVE_TEXTURE_BIT) != 0u) {
        ...
        if ((material.flags & GTA_MATERIAL_FLAGS_METALLIC_ROUGHNESS_TEXTURE_BIT) != 0u) {
        ...
        if ((material.flags & GTA_MATERIAL_FLAGS_OCCLUSION_TEXTURE_BIT) != 0u) {
        ...
        var Nt: vec3<f32>;
        if ((material.flags & GTA_MATERIAL_FLAGS_TWO_COMPONENT_NORMAL_MAP) != 0u) {
        ...
        if ((material.flags & GTA_MATERIAL_FLAGS_FLIP_NORMAL_MAP_Y) != 0u) {
            Nt.y = -Nt.y;
        }
        N = normalize(TBN * Nt);
#endif
        ...
        if ((material.flags & GTA_MATERIAL_FLAGS_ALPHA_MODE_OPAQUE) != 0u) {
            // NOTE: If rendering as opaque, alpha should be ignored so set to 1.0
            output_color.a = 1.0;
        } else if ((material.flags & GTA_MATERIAL_FLAGS_ALPHA_MODE_MASK) != 0u) {
